...
![Unedited version of Sixty5 MEP model](img/unedited-sixty5-mep-model.gif)

The performance is slow and buggy. I would not want to use this for more than a few minutes at a time. We notice expteremly slow `FPS` (Frames Per Second) as well.
